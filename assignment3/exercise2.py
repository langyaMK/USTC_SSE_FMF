...
# P \/ ~P
Todo("Exercise 2-1: try to prove the exclusive middle law if also valid")
P = Bool('P')
F = Or(P, Not(P))
solve(Not(F))
...
# ((P->Q)->P)->P)
Todo("Exercise 2-2: try to prove the validity of the Pierce's law")
P, Q = Bools('P Q')
...
Todo("Exercise 2-3: try to prove the validity of the proposition: (P -> Q) -> (~Q -> ~P)")
P, Q = Bools('P Q')
...
# to use.
Todo("Exercise 2-4: try to prove the validity of the proposition: (P -> Q /\\ R) -> ((P -> Q) /\\ (P -> R))")
P, Q, R = Bools('P Q R')
